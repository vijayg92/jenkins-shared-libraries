...
class Deployments {
    ...
    def deployOnDevCluster(dev_kubectl_contex_name, deploy_release_name, image_version, dev_tiller_namespace)     {
    ...
    def deployOnPreProdCluster(nonprod_kubelet_context_name, service_release_name, nonprod_tiller_name, nonprod_tiller_namespace, non_prod_cluster_domain) {
        sh """\
            #!/bin/bash
            set -ex
